...
class Cod_Order_New_Form {
	...
	public function remove_cod_form_template() {
		...
		add_action( 'after_cod_product_card_title', array( $this, 'cso_title_start_card' ) );
	}
	...
	public function cso_title_start() {
		require_once CSO_PLUGIN_DIR . 'inc/partials/cod-product-stars.php';
	}
	public function cso_title_start_card() {
